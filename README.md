...
<p align="center">
    ...
    <p align="center">
        ...
        <a href="https://goreportcard.com/report/github.com/avilabss/req-mod"><img src="https://goreportcard.com/badge/github.com/avilabss/req-mod" alt="Go Report Card"></a>
        <a href="https://pkg.go.dev/github.com/avilabss/req-mod"><img src="https://pkg.go.dev/badge/github.com/avilabss/req-mod.svg"></a>
...
```sh
go get github.com/avilabss/req-mod
```
...
```go
import "github.com/avilabss/req-mod"
```
...
:path: /uuid
:scheme: https
user-agent: req/v3 (https://github.com/avilabss/req-mod)
